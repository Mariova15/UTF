...
public class PruebaVista extends javax.swing.JFrame {
    ...
    public PruebaVista() {
        ...
        jTreeUserDir.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {            
                //System.out.println(jTreeUserDir.getLastSelectedPathComponent());
                //System.out.println(jTreeUserDir.getLeadSelectionPath().toString());
                ...
                File algo = new File(ruta + File.separator);
                File[] listFiles = algo.listFiles();
    ...
    private void pruebaFuente(String dirGoogleFont) {
        try {
                ...
                .addGroup(jPanelFondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanelFondoLayout.createSequentialGroup()
                        .addGroup(jPanelFondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(jLabel1TituloPrueba, javax.swing.GroupLayout.DEFAULT_SIZE, 154, Short.MAX_VALUE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanelFondoLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanelFondoLayout.createSequentialGroup()
    ...
    private void jButtonPreviewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPreviewActionPerformed
        pruebaFuente(cgf.getListaFuentes().get(jTableGoogleFonts.getSelectedRow()).getFiles().get(jComboBoxStyles.getSelectedItem().toString()));
